...
@section('navbar1', 'Data Mata Pelajaran')
@section('navbar2', 'Daftar Mata Pelajaran')
...
@section('javascript')
    ...
    {{-- <script>
        // Event listener untuk tab-tab di tab "mapel"
        $('[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
            var target = $(e.target).data('bs-target');
            showTabContent(target);
        });

        // Fungsi untuk menampilkan tab konten yang sesuai
        function showTabContent(target) {
            ...
            // Tampilkan tab konten yang sesuai dengan target
            $(target).addClass('active show');
        }

        // Saat halaman dimuat, pastikan hanya satu tab yang aktif di antara kedua grup tab
        showTabContent('#kelompok-a');
    </script> --}}
